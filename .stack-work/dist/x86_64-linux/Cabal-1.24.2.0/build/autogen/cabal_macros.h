...
/* package facebook-client-0.1.0.0 */
#define VERSION_facebook_client "0.1.0.0"
#define MIN_VERSION_facebook_client(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "facebook-client-0.1.0.0"

#define CURRENT_PACKAGE_KEY "facebook-client-0.1.0.0"
